    ...
    internal sealed class Configuration : DbMigrationsConfiguration<S00132671CA2.Models.MoviesContext>
    {
        ...
        protected override void Seed(S00132671CA2.Models.MoviesContext context)
        {
            ...
            context.Actors.AddOrUpdate(act => act.ActorName,
                new Actor() { ActorName = "Christian Bale", ActorId = 1, ActorImage="http://img2.timeinc.net/people/i/2011/database/110214/christian-bale-300.jpg", DOB = DateTime.Parse("1/30/1974"), Bio = "Christian Charles Philip Bale is an English actor. He has starred in both blockbuster films and smaller projects from independent producers and art houses." },
                  new Actor() { ActorName = "Tom Hardy", ActorImage="http://pmcdeadline2.files.wordpress.com/2014/04/tom-hardy__140404055255.jpg", ActorId = 2, DOB = DateTime.Parse("9/15/1977"), Bio="Tom Hardy is an English actor. His most notable film roles include Star Trek: Nemesis, RocknRolla, Bronson, Inception, Warrior, Tinker Tailor Soldier Spy, This Means War, The Dark Knight Rises, Lawless and Locke." },
                    new Actor() { ActorName = "Michael Caine", ActorId = 3, ActorImage="http://www.hellomagazine.com/imagenes/profiles/michael-caine/5876-michael-caine.jpg", DOB = DateTime.Parse("3/14/1933"), Bio = "Sir Michael Caine, CBE is an English actor and author. Renowned for his distinctive Cockney accent, Caine has appeared in over 115 films and is one of the UK's most recognisable actors."  });
